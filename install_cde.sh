...
sudo apt update
sudo apt install cde-desktop x11-apps xinit picom network-manager-gnome anarchism xsettingsd stalonetray firefox pulseaudio pavucontol audacious pnmixer dunst
